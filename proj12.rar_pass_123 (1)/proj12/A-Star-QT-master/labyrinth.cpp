...
void Labyrinth::draw_path()
{
    ...
    QDomElement root = document.createElement("Info");
    document.appendChild(root);

    QDomElement path = document.createElement("Path");
    root.appendChild(path);

    /*QFile file(":/rec/Resources/Write.xml");
    ...
    //coord = coord ;
    //xmlWriter.writeCharacters(coord);
	...
	while (currentNode != start)
	{
        ...
        //coord = ;
        coords = QString::number(currentNode.parentX) + " " + QString::number(currentNode.parentY);
        QDomElement coord = document.createElement("Coordinate");
        coord.setAttribute("", coords);
    ...
    //coord = ;
    //coord = QString::number(goal.x) + " " + QString::number(goal.y);
    //xmlWriter.writeCharacters(coord);
